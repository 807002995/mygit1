...
var gameEngine = {
	...
	//加载游戏
	loadding: function loadding(callback) {
		//logo
	...
	//监听键盘
	listeningKeybord: function listeningKeybord() {
	...
	//碰撞检测
	listeningCrash: function listeningCrash() {
	...
	//移动背景图
	moveBackground: function moveBackground() {
		var y = 0;
		setInterval(function () {
